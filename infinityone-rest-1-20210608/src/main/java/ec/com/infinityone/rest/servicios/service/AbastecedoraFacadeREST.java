...
import ec.com.infinity.modelo.Abastecedora;
...
public class AbastecedoraFacadeREST extends AbstractFacade<Abastecedora> {

    @PersistenceContext(unitName = "my_persistence_unit")
    private EntityManager em;

    public AbastecedoraFacadeREST() {
        super(Abastecedora.class);
    }

    @Override
    public Abastecedora create(Abastecedora entity) {
        return super.create(entity);
    }

    @Override
    public List<Abastecedora> findAll() {
        return super.findAll();
    }

    @Override
    public Abastecedora edit(Abastecedora entity) {
        super.edit(entity);
        return entity;
    }
    ...
    public Response find(@QueryParam("codigo") String codigo) {
        try {
            ...
            succesMessage.setStatusCode(200);
            succesMessage.setDeveloperMessage("ejecución correcta");
            List<Abastecedora> lst = new ArrayList<>();
    ...
    public Response findAll2() {
        try {
            ...
            succesMessage.setStatusCode(200);
            succesMessage.setDeveloperMessage("ejecución correcta");
            List<Abastecedora> lst = this.findAll();
            succesMessage.setRetorno(lst);
            return Response.status(200)
                    .entity(succesMessage)
                    .type(MediaType.APPLICATION_JSON).
