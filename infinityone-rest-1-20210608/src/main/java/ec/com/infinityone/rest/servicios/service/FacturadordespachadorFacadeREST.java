...
import ec.com.infinity.modelo.Facturadordespachador;
import ec.com.infinity.modelo.FacturadordespachadorPK;
 ...
 */
@Stateless
@Path("ec.com.infinity.modelo.facturadordespachador")
public class FacturadordespachadorFacadeREST extends AbstractFacade<Facturadordespachador> {

    @PersistenceContext(unitName = "my_persistence_unit")
    private EntityManager em;

    private FacturadordespachadorPK getPrimaryKey(PathSegment pathSegment) {
        /*
         * pathSemgent represents a URI path segment and any associated matrix parameters.
         * URI path part is supposed to be in form of 'somePath;codigocomercializadora=codigocomercializadoraValue;codigoterminal=codigoterminalValue;codigousuario=codigousuarioValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        ec.com.infinity.modelo.FacturadordespachadorPK key = new ec.com.infinity.modelo.FacturadordespachadorPK();
        ...
        java.util.List<String> codigousuario = map.get("codigousuario");
        if (codigousuario != null && !codigousuario.isEmpty()) {
            key.setCodigousuario(codigousuario.get(0));
        }
        return key;
    }

    public FacturadordespachadorFacadeREST() {
        super(Facturadordespachador.class);
    }

    @Override
    public Facturadordespachador create(Facturadordespachador entity) {
        return super.create(entity);
    }

    @Override
    public List<Facturadordespachador> findAll() {
        return super.findAll();
    }

    @Override
    public Facturadordespachador edit(Facturadordespachador entity) {
        super.edit(entity);
        return entity;
    }
    ...
    public Response findAll2() {
        try {
            ...
            succesMessage.setStatusCode(200);
            succesMessage.setDeveloperMessage("ejecución correcta");
            List<Facturadordespachador> lst = this.findAll();
            succesMessage.setRetorno(lst);
            return Response.status(200)
                    .entity(succesMessage)
                    .type(MediaType.APPLICATION_JSON).
