 ...
 */
@Stateless
@Path("ec.com.infinity.modelo.codigospetro")
public class CodigospetroFacadeREST extends AbstractFacade<Codigospetro> {

    @PersistenceContext(unitName = "my_persistence_unit")
    private EntityManager em;

    public CodigospetroFacadeREST() {
        super(Codigospetro.class);
    }

    @Override
    public Codigospetro create(Codigospetro entity) {
        return super.create(entity);
    }

    @Override
    public List<Codigospetro> findAll() {
        return super.findAll();
    }

    @Override
    public Codigospetro edit(Codigospetro entity) {
        super.edit(entity);
        return entity;
    }
    ...
    public Response findAll2() {
        try {
            ...
            succesMessage.setStatusCode(200);
            succesMessage.setDeveloperMessage("ejecución correcta");
            List<Codigospetro> lst = this.findAll();
            succesMessage.setRetorno(lst);
            return Response.status(200)
                    .entity(succesMessage)
                    .type(MediaType.APPLICATION_JSON).
