...
import ec.com.infinity.modelo.Direccioninen;
...
public class DireccioninenFacadeREST extends AbstractFacade<Direccioninen> {

    @PersistenceContext(unitName = "my_persistence_unit")
    private EntityManager em;

    public DireccioninenFacadeREST() {
        super(Direccioninen.class);
    }

    @Override
    public Direccioninen create(Direccioninen entity) {
        return super.create(entity);
    }

    @Override
    public List<Direccioninen> findAll() {
        return super.findAll();
    }

    @Override
    public Direccioninen edit(Direccioninen entity) {
        super.edit(entity);
        return entity;
    }
    ...
    public Response find(@QueryParam("codigo") String codigo) {
        try {
            ...
            succesMessage.setStatusCode(200);
            succesMessage.setDeveloperMessage("ejecución correcta");
            List<Direccioninen> lst = new ArrayList<>();
    ...
    public Response findAll2() {
        try {
            ...
            succesMessage.setStatusCode(200);
            succesMessage.setDeveloperMessage("ejecución correcta");
            List<Direccioninen> lst = this.findAll();
            succesMessage.setRetorno(lst);
            return Response.status(200)
                    .entity(succesMessage)
                    .type(MediaType.APPLICATION_JSON).
