...
import ec.com.infinity.modelo.Areamercadeo;
 ...
 */
@Stateless
@Path("ec.com.infinity.modelo.areamercadeo")
public class AreamercadeoFacadeREST extends AbstractFacade<Areamercadeo> {

    @PersistenceContext(unitName = "my_persistence_unit")
    private EntityManager em;

    public AreamercadeoFacadeREST() {
        super(Areamercadeo.class);
    }

    @Override
    public Areamercadeo create(Areamercadeo entity) {
        return super.create(entity);
    }

    @Override
    public List<Areamercadeo> findAll() {
        return super.findAll();
    }

    @Override
    public Areamercadeo edit(Areamercadeo entity) {
        super.edit(entity);
        return entity;
    }
    ...
    public Response findXId(@QueryParam("codigo") String codigo) {
        try {
            ...
            succesMessage.setStatusCode(200);
            succesMessage.setDeveloperMessage("ejecución correcta");
            List<Areamercadeo> lst = new ArrayList<>();
    ...
    public Response findAll2() {
        try {
            ...
            succesMessage.setStatusCode(200);
            succesMessage.setDeveloperMessage("ejecución correcta");
            List<Areamercadeo> lst = this.findAll();
            succesMessage.setRetorno(lst);
            return Response.status(200)
                    .entity(succesMessage)
                    .type(MediaType.APPLICATION_JSON).
