...
import ec.com.infinity.modelo.Tipocliente;
 ...
 */
@Stateless
@Path("ec.com.infinity.modelo.tipocliente")
public class TipoclienteFacadeREST extends AbstractFacade<Tipocliente> {
    ...
    @Override
    public Tipocliente edit(Tipocliente entity) {
        super.edit(entity);
        return entity;
    }
    ...
    public Response create1(Tipocliente entity) {
        try {
            this.create(entity);
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    public Response edit1(Tipocliente entity) {
        try {
            this.edit(entity);
            EjecucionMensaje succesMessage = new EjecucionMensaje();
            succesMessage.setStatusCode(200);
    ...
    public Response find(@QueryParam("codigo") String codigo) {
        try {
            ...
            succesMessage.setStatusCode(200);
            succesMessage.setDeveloperMessage("ejecución correcta");
            List<Tipocliente> lst = new ArrayList<>();
    ...
    public Response findAll2() {
        try {
            ...
            succesMessage.setStatusCode(200);
            succesMessage.setDeveloperMessage("ejecución correcta");
            List<Tipocliente> lst = this.findAll();
            succesMessage.setRetorno(lst);
            return Response.status(200)
                    .entity(succesMessage)
                    .type(MediaType.APPLICATION_JSON).
