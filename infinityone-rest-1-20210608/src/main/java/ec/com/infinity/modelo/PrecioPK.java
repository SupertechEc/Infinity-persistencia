...
public class PrecioPK implements Serializable {
   ...
   // @Size(min = 1, max = 20)
    ...
    public String toString() {
        return "ec.com.infinity.modelo.PrecioPK[ codigocomercializadora=" + codigocomercializadora + ", codigoterminal=" + codigoterminal + ", codigoproducto=" + codigoproducto + ", codigomedida=" + codigomedida + ", codigolistaprecio=" + codigolistaprecio + ", fechainicio=" + fechainicio + ", secuencial=" + secuencial + ", codigoPrecio=" + codigoPrecio + " ]";
    }
