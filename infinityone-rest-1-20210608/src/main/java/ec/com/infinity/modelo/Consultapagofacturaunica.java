...
@NamedQueries({
    ...
    @NamedQuery(name = "Consultapagofacturaunica.findByActivo", query = "SELECT c FROM Consultapagofacturaunica c WHERE c.activo = :activo"),
...
public class Consultapagofacturaunica implements Serializable {
    ...
    public Consultapagofacturaunica(ConsultapagofacturaunicaPK consultapagofacturaunicaPK, boolean activo) {
        this.consultapagofacturaunicaPK = consultapagofacturaunicaPK;
        this.activo = activo;
    }
