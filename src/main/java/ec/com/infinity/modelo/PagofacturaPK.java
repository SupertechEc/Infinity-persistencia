...
public class PagofacturaPK implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PagofacturaPK)) {
            return false;
        }
        PagofacturaPK other = (PagofacturaPK) object;
    ...
    public String toString() {
        return "ec.com.infinity.modelo.PagofacturaPK[ codigoabastecedora=" + codigoabastecedora + ", codigocomercializadora=" + codigocomercializadora + ", numero=" + numero + ", codigobanco=" + codigobanco + " ]";
    }
