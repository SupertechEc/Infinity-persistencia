...
@NamedQueries({
    ...
    @NamedQuery(name = "Precio.findByCodigo", query = "SELECT p FROM Precio p WHERE p.precioPK.codigo = :codigo"),
...
public class Precio implements Serializable {
    ...
    public Precio(String codigocomercializadora, String codigoterminal, String codigoproducto, String codigomedida, String codigolistaprecio, Date fechainicio, int secuencial, String codigo) {
        this.precioPK = new PrecioPK(codigocomercializadora, codigoterminal, codigoproducto, codigomedida, codigolistaprecio, fechainicio, secuencial, codigo);
    }
