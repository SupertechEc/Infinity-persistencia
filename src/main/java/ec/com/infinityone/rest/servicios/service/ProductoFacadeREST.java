...
import ec.com.infinity.modelo.Producto;
 ...
 */
@Stateless
@Path("ec.com.infinity.modelo.producto")
public class ProductoFacadeREST extends AbstractFacade<Producto> {
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    public Response remove(Producto entity) {
        try {
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    public Response find(Producto entity) {
        try {
    ...
    public Response findAll2() {
        try {
            ...
            succesMessage.setStatusCode(200);
            succesMessage.setDeveloperMessage("ejecución correcta");
            List<Producto> lst = this.findAll();
            succesMessage.setRetorno(lst);
            return Response.status(200)
                    .entity(succesMessage)
                    .type(MediaType.APPLICATION_JSON).
